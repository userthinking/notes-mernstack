...
const Login = ({ onSwitchToSignup }) => {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-blue-100 via-indigo-100 to-pink-100 flex justify-center items-center p-4">
      <div className="backdrop-blur-xl bg-white/70 border border-white/40 shadow-2xl rounded-3xl p-8 w-96 flex flex-col justify-center relative">
        {/* Logo/Avatar */}
        <div className="flex flex-col items-center mb-4">
          ...
          <h1 className="text-2xl font-extrabold text-gray-800 mb-1 tracking-tight text-center">Sign In</h1>
          <p className="text-gray-500 text-xs text-center">Welcome back!</p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-10 pr-4 py-2.5 rounded-xl border-2 transition-all duration-200 bg-white/60 focus:bg-white/90 shadow-sm ${
                  errors.username
